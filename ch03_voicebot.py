...
##### 기능 구현 함수 #####
def STT(audio, apikey):           ############ 4주차 실습문제 7번 : (3.8) STT 함수를 이용하여, 음성 파일을 텍스트로 변환하여 저장하는 코드를 추가하시오.  ############
       # 파일 저장
       filename='input.mp3'
...
def main():
        ...
        # 사이드바 생성           ########### 4주차 실습문제 4번 : (3.7, p.75-84) streamlit을 이용하여, 음성 비서 프로그램 UI를 만드시오. ###########
        with st.sidebar:
                ...
                # 리셋 버튼 생성                      ########### 4주차 실습문제 5번 : (3.7.1) session_state 함수를 추가하시오. ###########
        ...
        with col1:
               # 왼쪽 영역 작성            ########### 4주차 실습문제 6번 : (3.7.2) streamliet-audiorecoder 설치 후, 녹음 버튼과 녹음 파일 재생 버튼을 만들고 동작을 확인하시오. ###########
               st.subheader("질문하기")
               # 음성 녹음 아이콘 추가
        ...
        with col2:
               ...
               # 채팅 형식으로 시각화 하기         ########### 4주차 실습문제 8번 : (3.9) ask_gpt 함수를 만들고, 채팅을 시각화하는 코드를 참고하여, [그림 3.26]과 같은 채팅 형식의 UI를 작성하시오.
